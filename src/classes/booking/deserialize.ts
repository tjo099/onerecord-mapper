...
export function deserializeBooking(
  ...
  const r = BookingSchema.safeParse(pre.value)
  if (!r.success) {
  ...
  return { ok: true, value: nullProtoClone(r.data) as Booking }
}
