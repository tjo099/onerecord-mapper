...
export { CO2EmissionsCodec } from './classes/co2-emissions/index.js'
export { ChangeCodec } from './classes/change/index.js'
export { ChangeRequestCodec } from './classes/change-request/index.js'
export { ComposingCodec } from './classes/composing/index.js'
export { CompanyCodec } from './classes/company/index.js'
export { CustomsInformationCodec } from './classes/customs-information/index.js'
...
export { OtherChargeCodec } from './classes/other-charge/index.js'
...
export { RegulatedEntityCodec } from './classes/regulated-entity/index.js'
export { SecurityDeclarationCodec } from './classes/security-declaration/index.js'
export { ULDCodec } from './classes/uld/index.js'
export { UnitCompositionCodec } from './classes/unit-composition/index.js'
...
export { WaybillLineItemCodec } from './classes/waybill-line-item/index.js'
